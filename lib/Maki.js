...
var Maki = function( config ) {
  ...
  // TODO: determine how to expose this functionality extensibly,
  // a la provide: https://github.com/martindale/provide
  ...
  self.app.use( require('maki-assets') );
  self.app.use( provide() );
  self.app.use( require('maki-forms') );
