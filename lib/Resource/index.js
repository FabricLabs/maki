...
var Resource = function( name , options ) {
  ...
  self.handlers = _.extend({
    'html': {
      create: function( req , res , next) {
        req.flash('success', nameLower + ' created successfully!');
        // TODO: not use req.param here, as it feels dirty
        return res.redirect('/' + self.collection + '/' + req.param('id') );
      }
    }
  }, options.handlers );
...
Resource.prototype.update = function( params , complete ) {
  var self = this;
  var Model = self.Model;
