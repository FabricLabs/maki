    ...
    for (var name in maki.resources) {
      ...
      if ( resource.regex.test( ws.upgradeReq.url ) ) {
          ...
          if (data.jsonrpc === '2.0') {
            ...
            switch( data.method ) {
              case 'subscribe':
                ...
                console.log( '[SOCKETS] subscribe event, ' , data.params.channel );
              ...
              case 'unsubscribe':
                ...
                console.log( '[SOCKETS] unsubscribe event, ' , data.params.channel );
        ...
        ws.on('close', function() {
          console.log('[SOCKETS] cleaning expired websocket: ', ws.upgradeReq.headers['sec-websocket-key'] );
          ws.redis.end();
